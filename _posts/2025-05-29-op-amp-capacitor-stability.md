...
With some mathematics, it is possible to determine the optimum values which ensure both stability and performance. The detailed equations, rather long, are presented in this page: <a href="{{ '/posts/op-amp-capacitor-stability-equations.html' | relative_url }}">{{ '/posts/op-amp-capacitor-stability-equations.html' | relative_url }}</a>.
