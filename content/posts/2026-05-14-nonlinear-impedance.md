...
<figure>
  <picture>
      <img src="/posts/nonlinear-impedance/non-lineaire-b2-a1.svg" style="width:100%;"/>
  </picture>
...
<figure>
  <picture>
      <img src="/posts/nonlinear-impedance/non-lineaire-r2-a1.svg" style="width:100%;"/>
  </picture>
...
a_{2}(t) &= a_{2,\text{LSOP}}(t) + \frac{ \delta A_{2} \cdot e^{i \omega t} + (\delta A_{2})^* \cdot e^{- i \omega t} }{2}
\end{align}
</latexmath>
...
<latexmath>
\begin{split}
b_{2}(t) &= G\cdot\left[\frac{A_1 \cdot e^{i \omega t}+A_{1}^*\cdot e^{- i \omega t}}{2}\right] + \Gamma\cdot\left[\frac{\delta A_{2} \cdot e^{i \omega t}+(\delta A_{2})^*\cdot e^{- i \omega t}}{2}\right]\\
&-\gamma\cdot\left[\frac{\delta A_{2} \cdot e^{i \omega t}+(\delta A_{2})^*\cdot e^{- i \omega t}}{2}\right]^3\\
&-\lambda\cdot\left[\frac{A_1 \cdot e^{i \omega t}+A_{1}^*\cdot e^{- i \omega t}}{2}\right]^2\cdot\left[\frac{\delta A_{2} \cdot e^{i \omega t}+(\delta A_{2})^*\cdot e^{- i \omega t}}{2}\right]
\end{split}
</latexmath>
...
<latexmath>
\begin{split}
b_{2}(t) &= \left[ \frac{G}{2} \cdot A_1 - \frac{3 \gamma}{8} \left|A_1\right|^2 \cdot A_1 + \frac{\Gamma}{2} \cdot \delta A_{2} - \frac{A_1 \cdot A_{1}^* }{4} \cdot \lambda \cdot \delta A_{2} - \frac{A_{1}^{2} \cdot \lambda}{8} \cdot (\delta A_{2})^* \right] \cdot e^{i \omega t} \\
&+ \left[ - \frac{A_{1}^{2}}{8} \cdot \left(A_1 \cdot \gamma + \delta A_{2} \cdot \lambda \right) \right] \cdot e^{3 i \omega t} \\
&+ \text{conjugate terms}
\end{split}
</latexmath>
...
<latexmath>
B_{2} = G \cdot A_{1} - \frac{3 \cdot \gamma}{4} \left|A_1\right|^2 \cdot A_{1} + \Gamma \cdot A_{2} - \frac{A_1 \cdot A_{1}^*}{2} \cdot \lambda \cdot \delta A_{2} - \frac{A_{1}^{2} \cdot \lambda}{4} \cdot (\delta A_{2})^*
</latexmath>

which we rewrite in a simpler form:

<latexmath>
B_{2} = \underbrace{S_{21}^{\phantom{*}}(A_1)\cdot A_1}_\text{Amplification} + \underbrace{S_{22}^{\phantom{*}}(A_1)\cdot \delta A_{2}}_\text{Normal reflection} + \underbrace{T_{22}^{\phantom{*}}(A_1)\cdot (\delta A_2)^*}_\text{Conjugate reflection}
</latexmath>
...
<figure>
  <picture>
      <img src="/posts/nonlinear-impedance/non-lineaire-complexe-B2-A1.svg" style="width:100%;"/>
  </picture>
...
<figure>
  <picture>
      <img src="/posts/nonlinear-impedance/non-lineaire-S21.svg" style="width:100%;"/>
  </picture>
...
<figure>
  <picture>
      <img src="/posts/nonlinear-impedance/non-lineaire-complexe-B2-B2-A1.svg" style="width:100%;"/>
  </picture>
...
<figure>
  <picture>
      <img src="/posts/nonlinear-impedance/non-lineaire-complexe-deltaB2-B2-A1.svg" style="width:100%;"/>
  </picture>
  <figcaption><latexinline>\delta B_2</latexinline> when <latexinline>\delta A_2</latexinline> describes a unit circle for different values of <latexinline>A_1</latexinline>.</figcaption>
</figure>
...
<figure>
  <picture>
      <img src="/posts/nonlinear-impedance/non-lineaire-S22-T22.svg" style="width:100%;"/>
  </picture>
...
<figure>
  <picture>
      <img src="/posts/nonlinear-impedance/non-lineaire-Gamma2.svg" style="width:100%;"/>
  </picture>
...
<figure>
  <picture>
      <img src="/posts/nonlinear-impedance/CGHV14500-datasheet-impedances.svg" style="width:100%;"/>
  </picture>
