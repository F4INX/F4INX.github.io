...
excerpt: "This content was originally published on Microwaves 101 (https://www.microwaves101.com/encyclopedias/capacitor-voltage-effects). Many thanks to Steve for improvements on the original version. Have a look on his website for more interesting content."
---
...
<script>
	async function makeplot() {
        url = "/posts/MLCC-voltage-dependence/GRM188R61A475KE15.csv";
...
<img src="/posts/MLCC-voltage-dependence/radiospares-3.png">
<img src="/posts/MLCC-voltage-dependence/radiospares-4.png">
...
<script>
	async function makeplot() {
        ...
        /* Plot */
        var traces = [
            await get_trace("/posts/MLCC-voltage-dependence/GRM32ER61A107ME20.csv", name="Murata GRM32ER61A107ME20"),
            {x: [5.0], y: [45.94741861], mode: 'markers', showlegend: false, marker: {symbol: 'x', size: 10}},
            await get_trace("/posts/MLCC-voltage-dependence/C3216X5R1A107M160AC.csv", name="TDK C3216X5R1A107M160AC"),
            {x: [5.0], y: [28.7599], mode: 'markers', showlegend: false, marker: {symbol: 'x', size: 10}},
            await get_trace("/posts/MLCC-voltage-dependence/C1210C107M8PACTU.csv", name="Kemet C1210C107M8PACTU"),
...
<img src="/posts/MLCC-voltage-dependence/temperature.png">
