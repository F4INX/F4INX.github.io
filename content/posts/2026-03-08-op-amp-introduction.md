...
{{% begin-note %}}
After some discussions on grounding and various subjects with <a href="https://gonuldemir.github.io/">Gönül Demir</a>, we thought that it could be a good idea to combine our both approaches to make a join page. Indeed I began my series by writing detailed articles about complex points and not by an introduction. We hope that this gentle (or not so) introduction to the topic would fill the gap.
{{% /begin-note %}}
...
<figure>
  <picture>
      <source srcset="/posts/op-amp-introduction/wien-without-agc.png" media="(prefers-color-scheme: light)"/>
      <source srcset="/posts/op-amp-introduction/wien-without-agc-dark.png" media="(prefers-color-scheme: dark)"/>
      <img src="/posts/op-amp-introduction/wien-without-agc.png" style="width:75%;"/>
  </picture>
...
<figure>
  <picture>
      <source srcset="/posts/op-amp-introduction/wien-without-agc-plot.png" media="(prefers-color-scheme: light)"/>
      <source srcset="/posts/op-amp-introduction/wien-without-agc-plot-dark.png" media="(prefers-color-scheme: dark)"/>
      <img src="/posts/op-amp-introduction/wien-without-agc-plot.png" style="width:100%;"/>
  </picture>
...
<figure>
  <picture>
      <source srcset="/posts/op-amp-introduction/wien-with-agc.png" media="(prefers-color-scheme: light)"/>
      <source srcset="/posts/op-amp-introduction/wien-with-agc-dark.png" media="(prefers-color-scheme: dark)"/>
      <img src="/posts/op-amp-introduction/wien-with-agc.png" style="width:75%;"/>
  </picture>
  <figcaption>Schematic of a wien bridge oscillator without automatic gain control.</figcaption>
</figure>
...
<figure>
  <picture>
      <source srcset="/posts/op-amp-introduction/wien-with-agc-plot.png" media="(prefers-color-scheme: light)"/>
      <source srcset="/posts/op-amp-introduction/wien-with-agc-plot-dark.png" media="(prefers-color-scheme: dark)"/>
      <img src="/posts/op-amp-introduction/wien-with-agc-plot.png" style="width:100%;"/>
  </picture>
...
<figure>
  <picture>
      <source srcset="/posts/op-amp-introduction/wien-with-agc-zoom.png" media="(prefers-color-scheme: light)"/>
      <!-- <source srcset="/posts/op-amp-introduction/wien-with-agc-zoom-dark.png" media="(prefers-color-scheme: dark)"/> -->
      <img src="/posts/op-amp-introduction/wien-with-agc-zoom-dark.png" style="width:75%;"/>
  </picture>
...
<figure>
  <picture>
      <source srcset="/posts/op-amp-introduction/wien-with-agc-zoom-plot.png" media="(prefers-color-scheme: light)"/>
      <source srcset="/posts/op-amp-introduction/wien-with-agc-zoom-plot-dark.png" media="(prefers-color-scheme: dark)"/>
      <img src="/posts/op-amp-introduction/wien-with-agc-zoom-plot.png" style="width:100%;"/>
  </picture>
...
<figure>
  <picture>
      <source srcset="/posts/op-amp-introduction/rc-comp-oscillator.png" media="(prefers-color-scheme: light)"/>
      <source srcset="/posts/op-amp-introduction/rc-comp-oscillator-dark.png" media="(prefers-color-scheme: dark)"/>
      <img src="/posts/op-amp-introduction/rc-comp-oscillator.png" style="width:25%;"/>
  </picture>
...
<figure>
  <picture>
      <source srcset="/posts/op-amp-introduction/rc-comp-oscillator-plot.png" media="(prefers-color-scheme: light)"/>
      <source srcset="/posts/op-amp-introduction/rc-comp-oscillator-plot-dark.png" media="(prefers-color-scheme: dark)"/>
      <img src="/posts/op-amp-introduction/rc-comp-oscillator-plot.png" style="width:100%;"/>
  </picture>
...
<td>
  <picture>
    <source srcset="/posts/op-amp-introduction/bjt-amp-1.png" media="(prefers-color-scheme: light)"/>
    <source srcset="/posts/op-amp-introduction/bjt-amp-1-dark.png" media="(prefers-color-scheme: dark)"/>
    <img src="/posts/op-amp-introduction/bjt-amp-1.png" style="width:100%;"/>
  </picture>
</td>
<td>
  <picture>
    <source srcset="/posts/op-amp-introduction/bjt-amp-2.png" media="(prefers-color-scheme: light)"/>
    <source srcset="/posts/op-amp-introduction/bjt-amp-2-dark.png" media="(prefers-color-scheme: dark)"/>
    <img src="/posts/op-amp-introduction/bjt-amp-2.png" style="width:100%;"/>
  </picture>
</td>
</tr>
</table>
...
<figure>
  <picture>
    <source srcset="/posts/op-amp-introduction/fet-amp.png" media="(prefers-color-scheme: light)"/>
    <source srcset="/posts/op-amp-introduction/fet-amp-dark.png" media="(prefers-color-scheme: dark)"/>
    <img src="/posts/op-amp-introduction/fet-amp.png" style="width:75%;"/>
  </picture>
...
<figure>
  <picture>
    <source srcset="/posts/op-amp-introduction/auto-zero.png" media="(prefers-color-scheme: light)"/>
    <source srcset="/posts/op-amp-introduction/auto-zero-dark.png" media="(prefers-color-scheme: dark)"/>
    <img src="/posts/op-amp-introduction/auto-zero.png" style="width:75%;"/>
  </picture>
...
<figure>
  <img src="/posts/op-amp-introduction/tl081.png" />
...
<figure>
  <img src="/posts/op-amp-introduction/tl081-datasheet.png" />
...
<figure>
  <img src="/posts/op-amp-introduction/p-input.png" />
...
<figure>
  <img src="/posts/op-amp-introduction/opa391-input.png" />
...
<figure>
  <img src="/posts/op-amp-introduction/offset.png" />
...
<figure>
  <img src="/posts/op-amp-introduction/resistances.png" />
...
<figure>
  <img src="/posts/op-amp-introduction/lm324-datasheet.png" />
...
<figure>
  <img src="/posts/op-amp-introduction/ne5532-datasheet.png" />
...
<figure>
  <img src="/posts/op-amp-introduction/slew-rate.png" />
...
See article on this subject:  <a href="/posts/op-amp-capacitor-stability.html</a>.
...
<figure>
  <img src="/posts/op-amp-introduction/decoupling.png" />
...
<figure>
  <img src="/posts/op-amp-introduction/ultrasonic-pcb.svg" />
