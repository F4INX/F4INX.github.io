...
excerpt: "The discrete Hilbert transform seems rather mysterious, but it is mainly a way to add a 90° phase shift to a signal which can be explained by an Excel spreadsheet."
---
...
![](/posts/hilbert-transform-demo/pulse-series.png)
...
![](/posts/hilbert-transform-demo/hilbert-series.png)
...
![](/posts/hilbert-transform-demo/hilbert-limit.png)
...
* Hilbert transform demo [French]: [Hilbert-demo.xlsx]({{ '/Excel/Hilbert-demo.xlsx).
* Hilbert transform demo [English]: [Hilbert-demo-EN.xlsx]({{ '/Excel/Hilbert-demo-EN.xlsx).
