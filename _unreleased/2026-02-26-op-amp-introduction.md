...
<figure>
  <picture>
      <source srcset="{{ '/posts/op-amp-introduction/rc-phase-shift-oscillator-plot-startup.png' | relative_url }}" media="(prefers-color-scheme: light)"/>
      <source srcset="{{ '/posts/op-amp-introduction/rc-phase-shift-oscillator-plot-startup-dark.png' | relative_url }}" media="(prefers-color-scheme: dark)"/>
